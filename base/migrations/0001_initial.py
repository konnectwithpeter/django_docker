# Generated by Django 5.0 on 2024-10-03 14:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image1', models.ImageField(blank=True, null=True, upload_to='static/property_images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image1', models.ImageField(blank=True, null=True, upload_to='static/maintenance-requests/')),
                ('image2', models.ImageField(blank=True, null=True, upload_to='static/maintenance-requests/')),
                ('image3', models.ImageField(blank=True, null=True, upload_to='static/maintenance-requests/')),
                ('video', models.FileField(blank=True, null=True, upload_to='static/maintenance-requests/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(blank=True, null=True, upload_to='static/invoices/')),
                ...
                ('property', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='invoices', to='base.property')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_status', models.CharField(choices=[('success', 'Success'), ('fail', 'Fail')], default='fail', max_length=10)),
                ('transaction_id', models.CharField(blank=True, max_length=100, null=True)),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transactions', to='base.rentinvoice')),
            ],
        ),
        migrations.CreateModel(
            name='VacateNotice',
